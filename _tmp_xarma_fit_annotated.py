...
def simulate_arma(n, ar = None, ma = None, sigma: float = 1.0, burn: int = 1000, seed = None):
    """
...
def theoretical_acf_arma(ar, ma, k: int, npsi = None):
    """
...
def theoretical_pacf_arma(ar, ma, k: int, npsi = None):
    """
